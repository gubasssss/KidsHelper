  ...
  export default function UserProfileScreen() {
      ...
      const [totalCoins, setTotalCoins] = useState<number>(0); // Estado para armazenar as moedas

      useEffect(() => {
        loadTotalCoins(); // Carrega as moedas quando o componente é montado
    }, []);
    ...
    const loadTotalCoins = async () => {
      ...
      if (savedCoins) {
          ...
          setTotalCoins(parsedCoins); // Atualiza o estado com as moedas carregadas
      }
  };
    ...
    const menuOptions = [
      { label: 'Tarefas', action: () => router.push("/(tabs)/tarefas") },
      ...
      <View style={styles.container}>
        ...
        <View style={styles.cardContainer}>
          <TouchableOpacity style={[styles.card, styles.rewardCard]}>
            ...
            <Text style={styles.cardPoints}>{totalCoins} Pontos</Text>
          </TouchableOpacity>
